...
public class PlayerdataConfig {
    ...
    public static void setup() {
        file = new File(NewKitPvP.getInstance().getDataFolder(), "playerdata.yml");
        ...
        InputStream customClassStream = NewKitPvP.getInstance().getClass().getResourceAsStream("/playerdata.yml");
