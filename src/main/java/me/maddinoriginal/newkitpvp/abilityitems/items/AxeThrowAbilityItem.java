...
public class AxeThrowAbilityItem extends AbilityItem {

    @Override
    public String getName() {
        return "Axe Throw Ability";
    }
    ...
    public List<String> getLore() {
        return Arrays.asList("Throws an axe in front");
    }

    @Override
    public AbilityType getAbilityType() {
        return AbilityType.AXE_THROW;
    }

    @Override
    public void handleLeftClick(Player player, ItemStack item, PlayerInteractEvent event) {
        //AbilityType.AXE_THROW.getAbility().useAbility(player);
    }
