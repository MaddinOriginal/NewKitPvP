...
public class MinigunAbilityItem extends AbilityItem {

    @Override
    public String getName() {
        return "Minigun Ability";
    }
    ...
    public List<String> getLore() {
        return Arrays.asList("Right click to activate the minigun!");
    }

    @Override
    public AbilityType getAbilityType() {
        return AbilityType.MINIGUN;
    }
    ...
    public void handleRightClick(Player player, ItemStack item, PlayerInteractEvent event) {
        AbilityType.MINIGUN.getAbility().useAbility(player);
    }
}
